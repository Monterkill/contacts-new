...
public class QueryCallCountByTimeTask extends Task {

    private long _start_ts;
    private long _end_ts;

    public QueryCallCountByTimeTask(long start_ts, long end_ts){
        _start_ts = start_ts;
        _end_ts = end_ts;
    }
    ...
    public int exec() {
        ...
        //计算这些通话记录的总次数
        Integer callCount = callRecords.size();
        //设置计算结果
        setResult(callCount);
        //打印日志
        LogBus.Log(LogBus.DEBUGTAGS, "count all call records count success");
    ...
    public static void test1(){
        ...
        Task test_task = new QueryCallCountByTimeTask(0, 60);
