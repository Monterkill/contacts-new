...
public class QueryContactsByKeyWordsTask extends Task {

    private String _KW;

    public QueryContactsByKeyWordsTask(String KW)
    {
        _KW = KW;
    }
    ...
    public int exec(){
        //获取所有通话记录
        List callRecords = ResourceManager.getInstance().getAllContacts();
        //根据关键词过滤出指定的通话记录
        try {
            callRecords = MyUtil.filterContactsByKeyWords(callRecords, _KW);
    ...
    public static void test1(){
        ...
        Task test_task = new QueryContactsByKeyWordsTask("hjz");
